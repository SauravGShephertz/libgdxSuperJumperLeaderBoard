...
public class Assets {
	...
	public static Texture register;
	public static Texture enterName;
	public static Texture enterEmail;
	public static Texture enterPass;
...
//	private static String prefix = "";
	public static void load () {
		...
		register = loadTexture(prefix+"register.png");
		enterName = loadTexture(prefix+"enterName.png");
		enterEmail = loadTexture(prefix+"enterEmail.png");
		enterPass = loadTexture(prefix+"enterPass.png");
		submit = loadTexture(prefix+"submit.png");
